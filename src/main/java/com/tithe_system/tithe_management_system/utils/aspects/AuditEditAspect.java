...
public class AuditEditAspect {

    private AuditRepository auditRepository;

    public AuditEditAspect(AuditRepository auditRepository) {
        this.auditRepository = auditRepository;
    }

    @Around("@annotation(com.tithe_system.tithe_management_system.utils.trackers.AuditEditEvent) && args(object, locale, username)")
    public Object around(ProceedingJoinPoint joinPoint, Object object, Locale locale, String username) throws Throwable {
        ...
        auditTrail.setAction(RecordAction.EDIT.name());
